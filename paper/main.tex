...
times of the replication onto the solver times of the original batches; because the
replication ran under concurrent load, its preprocessing component is if anything
overstated, so the sensitivity is conservative towards the role-blind rule. The effect is
substantial. The median ratios collapse towards parity---in Simple from $1.029$ to $1.003$
at $1\%$ and from $1.032$ to $1.010$ at $0.1\%$, in SG-Ter-Mer from $1.053$ to $1.007$ and
from $1.047$ to $1.016$---and, of the eight fast-class contrasts whose prototype
preprocessing-plus-solver ordering had adjusted values below $0.05$, only two retain
them: the coefficient-only Simple contrast at $1\%$ ($q_{6}<0.001$) and the augmented
Simple contrast at $0.1\%$ ($q_{6}=0.003$). The augmented SG-Ter-Mer contrasts fall to
$q_{6}=0.064$ and $0.055$, and both coefficient-only SG-Ter-Mer contrasts to $q_{6}\ge0.2$.
The Full augmented direction is unchanged in sign and comparable in strength
($0.877$, $q_{6}=0.052$ at $0.1\%$). Read together with the phase breakdown, the operational
...
\midrule
\multirow{6}{*}{$1\%$}
 & Simple & Aug & 204 & 1.0026 & $-0.189$ & 0.058 \\
 & Simple & Mat & 204 & 1.0068 & $-0.502$ & $<0.001$ \\
 & SG-Ter-Mer & Aug & 67 & 1.0068 & $-0.301$ & 0.064 \\
 & SG-Ter-Mer & Mat & 67 & 1.0052 & $-0.189$ & 0.215 \\
 & Full & Aug & 31 & 0.9217 & $+0.351$ & 0.135 \\
 & Full & Mat & 32 & 0.9907 & $+0.231$ & 0.262 \\
\midrule
\multirow{6}{*}{$0.1\%$}
 & Simple & Aug & 204 & 1.0100 & $-0.278$ & 0.003 \\
 & Simple & Mat & 203 & 1.0009 & $-0.072$ & 0.445 \\
 & SG-Ter-Mer & Aug & 67 & 1.0159 & $-0.310$ & 0.055 \\
 & SG-Ter-Mer & Mat & 67 & 1.0096 & $-0.155$ & 0.407 \\
 & Full & Aug & 27 & 0.8772 & $+0.519$ & 0.052 \\
 & Full & Mat & 27 & 0.9805 & $+0.048$ & 0.841 \\
\bottomrule
\end{tabular}
\end{table}
...
endpoint. The \emph{magnitude}, moreover, is protocol-dependent: under the replication's
concurrent load the median paired selective-to-Flat ratio is $6.1$--$9.1\times$, against
$2.7$--$3.1\times$ on the smaller absolute values of the dedicated batches (per-cell
medians, dispersion, and family counts in Table~S10). We therefore read the direction of
the preprocessing gap as established and its absolute size as specific to the machine and
load under which it is measured.
