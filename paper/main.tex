...
shift favoring the external rule in SG-Ter-Mer, and a tolerance-dependent outcome in Full. The metadata's value is therefore
...
(Figures~S1--S4) and sixteen tables---hyperparameter sensitivity (Table~S1), the per-variant
...
length revision---the two $0.1\%$-tolerance efficiency tables (Tables~S14--S15) and the
internal-scaling comparison (Table~S16).
