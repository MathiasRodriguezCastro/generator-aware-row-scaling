...
produces, so we verified that directly: exporting the scaled model with both builds on six
instances spanning the three classes and both kernels, in selective and role-blind mode, gives
$24/24$ byte-identical exports. The two builds therefore differ in speed alone, not in row
factors, scaled rows, or safeguard decisions. This build comparison provides one observed
policy-specific
