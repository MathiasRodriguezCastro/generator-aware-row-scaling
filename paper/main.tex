...
=T_{\mathrm{diagnosis}}+T_{\mathrm{application}}+T_{\mathrm{solver}}$ (\cref{tab:flat-cached}).
...
body (\cref{tab:flat-reliability-body}). In Simple, Flat-Aug wins intent-to-treat \PARten{}
