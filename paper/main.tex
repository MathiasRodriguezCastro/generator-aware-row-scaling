...
class--kernel cells, and is cheaper on $408$ of the $612$ instance--kernel records. So most
of the measured preprocessing penalty is an artifact of the prototype rebuilding metadata
it was given, but a small descriptive residual cost remains after removing metadata
reconstruction; its family-level robustness is reported separately below.
...
offset. That is precisely why the rank-based paired analysis favors Flat: the consistent
offset moves the typical instance, while the large solver differences neither cancel nor
concentrate. A per-instance share is not a useful summary here either: writing
